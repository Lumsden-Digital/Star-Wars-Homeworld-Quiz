...
function App() {
  ...
  useEffect(() => {
    (async function getData() {
      ...
      const peopleData1 = fetch("https://swapi.dev/api/people/", {
        method: "get",
        headers: {
      ...
      const peopleData2 = fetch("https://swapi.dev/api/people/?page=2").then(
        success
      );
      ...
      const planetLinks = peopleArray.map((personObj) =>
        personObj.homeworld.replace(/http/g, "https")
      );
